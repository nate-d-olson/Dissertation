...
## Abstract
```{r countAbstract, child="mgtst_pub/Abstract.Rmd", warning=FALSE, message=FALSE, echo = FALSE}
```
...
To use information from the unmixed samples to obtain expected count values for the titrations we first need to evaluate two assumptions about the mixed samples:
...
Exogenous DNA was spiked into the unmixed samples before mixing and quantified using qPCR to validate the the samples were volumetrically mixed according to the mixture design.
