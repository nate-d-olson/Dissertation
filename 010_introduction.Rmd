...
In Chapter \@ref(count-table), we describe the mixture dataset of extracted DNA from human stool samples for assessing 16S sequencing.
The mixture datasets were processed using three bioinformatic pipelines.
I developed metrics for qualitative and quantitative assessment of the bioinformatic pipeline results.
