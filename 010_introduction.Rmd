...
Recent advances in deoxyribonucleic acid (DNA) sequencing technology have changed how we measure, and thus study, microbiomes.
...
However, the approaches presented are applicable to assessing shotgun metagenomic methods as well.
...
A key component of measurement assessment are data with an expected value.
